...
### Добавлено
- arthas/STANDARD.md: скилл cost-tracker (14-й скилл)
  - Фактические траты OpenRouter после каждого алерта
  - arthas-spend.sh -- обёртка над or_manager.py
  - Формат: «Траты: $X.XX/час | $Y.YY/день»
  - Полный отчёт по запросу /cost
...
## Test PR (2026-03-09)
- Тестовый PR для проверки workflow конституции
