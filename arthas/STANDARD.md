...
|----------|--------|-------------|
| **Primary** | Grok 4.1 Fast | Дешёвая, быстрая. Мониторинг не требует сложных рассуждений |
| **Fallback** | Kimi K2.5 | Альтернатива при недоступности Grok |
| **Субагенты** | Grok 4.1 Fast | Max 5 параллельных |

**Fallback-цепочка:** Grok 4.1 Fast -> Kimi K2.5
