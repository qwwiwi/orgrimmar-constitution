...
Крипта/макро -> канал принца. DCA/AI/YouTube -> спроси. Не спрашивай лишний раз.
...
| Канал | Профиль |
|-------|---------|
| Telegram: канал принца | `memory/channels/channel-канал-принца.md` |
| Telegram: DCA $10 | `memory/channels/channel-dca.md` |
| Telegram: AI энтузиаст | `memory/channels/channel-ai.md` |
| YouTube: принц | `memory/channels/channel-youtube.md` |
...
- Любые новые идеи писать только в нужную секцию внутри `ideas/IDEAS.md` (`ideas-канал-принца`, `ideas-dca`, `ideas-ai`, `ideas-youtube`)
